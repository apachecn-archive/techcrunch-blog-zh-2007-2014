...
TripAdvisor 公司联合创始人兼首席执行官 Steve Kaufer 在一份声明中表示:“ "Flying 通常是旅行中必不可少的一部分，我们一直在开发我们的航班产品套件，从 TripAdvisor 上的价格和可用性搜索，到我们屡获殊荣的 SeatGuru.com，还有座位地图等等。”。“GateGuru 很好地补充了我们现有的航班产品，我们期待着与 GateGuru 团队合作，继续管理 GateGuru 应用程序，并为猫途鹰移动体验添加强大的功能。”这也有助于 GateGuru 处于一个无处不在的好位置，iOS、Android 和 Windows Phone 的应用程序已经就位。
...
![gateguru](img/ac6a6a952493bfbfa402f3db9d5d5c05.png)